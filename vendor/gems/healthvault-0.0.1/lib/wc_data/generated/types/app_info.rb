...
#<b>remarks</b>: If the application is a multi-record-application, then it must specify the attribute here. Upon successful authentication, a unique token will be issued for use with subsequent calls to the Microsoft Health Service.
