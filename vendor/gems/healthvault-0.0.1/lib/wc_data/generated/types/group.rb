...
#<b>remarks</b>: Each group in the Microsoft Health Service is assigned a unique identifier which is a 128-bit integer (16 bytes) and is used to identify the group when calling methods on the service.
