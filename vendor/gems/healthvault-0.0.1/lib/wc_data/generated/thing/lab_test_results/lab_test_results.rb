...
#<em>value</em> is a HealthVault::WCData::Thing::Types::Organization
        ...
        def initialize
          ...
          @children['lab-group'] = {:name => 'lab-group', :class => HealthVault::WCData::Thing::Types::Labtestresultsgrouptype, :value => Array.new, :min => 1, :max => 999999, :order => 2, :place => :element, :choice => 0 }
