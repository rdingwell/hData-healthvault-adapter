...
#<b>remarks</b>: An application can put any data in this portion of settings. The Microsoft Health Service does not interpret this data in any way and will return it to the application exactly as it was stored. The Microsoft Health Service does validate that the containing node is valid XML so some characters may need to be escaped or encoded.
