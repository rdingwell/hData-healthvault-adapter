...
#<b>remarks</b>: Most Microsoft Health Applications will work with single health record at a time. The Microsoft Health Service stores the most recently selected record identifier that the user chose to use with the application when the user authorized the application to access the record.
