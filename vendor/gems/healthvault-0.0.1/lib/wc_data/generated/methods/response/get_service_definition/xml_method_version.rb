...
#<b>remarks</b>: The version number for a Microsoft Health Service web-method is a sequencially increasing number starting at one. Breaking changes to a method will increment the version number for the method but old versions of a method are still available to handle requests. The method request must contain the appropriate method version number for the XML schema that it is sending.
#<em>value</em> is a String
        def number=(value)
