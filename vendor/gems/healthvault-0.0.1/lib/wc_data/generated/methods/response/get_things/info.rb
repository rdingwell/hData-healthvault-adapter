...
#<b>returns</b>: a HealthVault::WCData::Methods::Response::GetThings::ThingResponseGroup Array
        ...
        def initialize
          ...
          @children['group'] = {:name => 'group', :class => HealthVault::WCData::Methods::Response::GetThings::ThingResponseGroup, :value => Array.new, :min => 1, :max => 999999, :order => 1, :place => :element, :choice => 340154331 }
