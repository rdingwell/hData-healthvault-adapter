...
#<b>remarks</b>: If true, the Microsoft Health Service will ensure that only custodians with validated email addresses will be sent the message. Custodians with non-validated email addresses will be skipped. If no validated custodians are found, then an error will be returned.
