...
#<em>value</em> is a HealthVault::WCData::Auth::SimplePassportCredential
        ...
        def initialize
          ...
          @children['simple-passport'] = {:name => 'simple-passport', :class => HealthVault::WCData::Auth::SimplePassportCredential, :value => nil, :min => 1, :max => 1, :order => 1, :place => :element, :choice => 336182665 }
