...
#<b>remarks</b>: Currently not supported. Instead, each application is given access to the following default list of methods: - CreateAuthenticatedSessionToken - GetApplicationSettings - GetAuthorizedRecords - GetPersonInfo - GetServiceDefinition - GetThings - GetThingType - GetVocabulary - PutThings - QueryPermissions - RemoveThings - SetApplicationSettings
...
#<b>remarks</b>: The large logo can be up to 160kb in size.
...
#<em>value</em> is a String
        ...
        def initialize
          ...
          @children['description'] = {:name => 'description', :class => HealthVault::WCData::Types::Stringnz, :value => nil, :min => 1, :max => 1, :order => 7, :place => :element, :choice => 0 }
            
          @children['description'][:value] = HealthVault::WCData::Types::Stringnz.new
            
          
        
          
          @children['auth-reason'] = {:name => 'auth-reason', :class => HealthVault::WCData::Types::Stringnz, :value => nil, :min => 1, :max => 1, :order => 8, :place => :element, :choice => 0 }
            
          @children['auth-reason'][:value] = HealthVault::WCData::Types::Stringnz.new
