...
#<em>value</em> is a HealthVault::WCData::Types::Stringnz
        ...
        def initialize
          ...
          @children['old-external-id'] = {:name => 'old-external-id', :class => HealthVault::WCData::Types::Stringnz, :value => nil, :min => 1, :max => 1, :order => 1, :place => :element, :choice => 0 }
            
          @children['old-external-id'][:value] = HealthVault::WCData::Types::Stringnz.new
            
          
        
          
          @children['new-external-id'] = {:name => 'new-external-id', :class => HealthVault::WCData::Types::Stringnz, :value => nil, :min => 1, :max => 1, :order => 2, :place => :element, :choice => 0 }
