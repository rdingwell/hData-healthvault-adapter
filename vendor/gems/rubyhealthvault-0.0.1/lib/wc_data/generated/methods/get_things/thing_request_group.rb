...
#<em>value</em> is a HealthVault::WCData::Methods::GetThings::ThingFormatSpec
        ...
        #<b>summary</b>: Specifies whether or not we should return only the current version of things that satisfy the filter. This is true by default.
#<b>remarks</b>: This can be set to false only by the auditing subsystem.
