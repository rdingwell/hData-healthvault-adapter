...
#<b>returns</b>: a HealthVault::WCData::Vocab::VocabularyKeyInfo Array
        ...
        def initialize
          ...
          @children['vocabulary'] = {:name => 'vocabulary', :class => HealthVault::WCData::Vocab::VocabularyCodeSet, :value => Array.new, :min => 1, :max => 999999, :order => 1, :place => :element, :choice => 120327194 }
          
        
          
          @children['vocabulary-key'] = {:name => 'vocabulary-key', :class => HealthVault::WCData::Vocab::VocabularyKeyInfo, :value => Array.new, :min => 1, :max => 999999, :order => 2, :place => :element, :choice => 120327194 }
