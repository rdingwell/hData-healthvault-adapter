  ...
  module Application
      ...
      class AppLargeLogoInfo < ComplexType
        ...
        def initialize
          ...
          @children['logo'] = {:name => 'logo', :class => HealthVault::WCData::Application::AppLargeLogo, :value => nil, :min => 1, :max => 1, :order => 1, :place => :element, :choice => 0 }
            
          @children['logo'][:value] = HealthVault::WCData::Application::AppLargeLogo.new
